        ...
        <footer className="bg-gray-100 border-t-2">
            <div className="container mx-auto py-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div className="flex flex-col items-start">
                        <h3 className="text-gray-700 mb-4">Menu</h3>
                    ...
                    <div className="flex flex-col items-start">
                        <h3 className="text-gray-700 mb-4">Follow Us</h3>
                        <ul className="list-none text-gray-700 text-sm">
            ...
            <div className="bg-gray-200">
                <div className="container mx-auto py-4">
                    <p className="text-center text-gray-700 text-sm">
                        &copy; 2022 - {new Date().getFullYear()} All rights reserved. Designed by Idea Tech.
                    </p>
                </div>
            </div>
        </footer>
